...
Version  : 3.32.0
Release  : 15
URL      : https://download.gnome.org/sources/metacity/3.32/metacity-3.32.0.tar.xz
Source0  : https://download.gnome.org/sources/metacity/3.32/metacity-3.32.0.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1557082909
export AR=gcc-ar

...
Version  : 3.46.1
Release  : 34
URL      : https://download.gnome.org/sources/metacity/3.46/metacity-3.46.1.tar.xz
Source0  : https://download.gnome.org/sources/metacity/3.46/metacity-3.46.1.tar.xz
...
%prep
%setup -q -n metacity-3.46.1
cd %{_builddir}/metacity-3.46.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680039771

...
Version  : 3.42.0
Release  : 27
URL      : https://download.gnome.org/sources/metacity/3.42/metacity-3.42.0.tar.xz
Source0  : https://download.gnome.org/sources/metacity/3.42/metacity-3.42.0.tar.xz
...
%prep
%setup -q -n metacity-3.42.0
cd %{_builddir}/metacity-3.42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635382083
...
cp %{_builddir}/metacity-3.42.0/COPYING %{buildroot}/usr/share/package-licenses/metacity/7222ccadf8bf66ff80f555df6cd9882482d6622e
%make_install
%find_lang metacity

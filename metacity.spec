...
Version  : 3.52.0
Release  : 36
URL      : https://download.gnome.org/sources/metacity/3.52/metacity-3.52.0.tar.xz
Source0  : https://download.gnome.org/sources/metacity/3.52/metacity-3.52.0.tar.xz
...
%prep
%setup -q -n metacity-3.52.0
cd %{_builddir}/metacity-3.52.0
pushd ..
cp -a metacity-3.52.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710973647

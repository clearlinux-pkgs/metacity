...
Version  : 3.38.0
Release  : 25
URL      : https://download.gnome.org/sources/metacity/3.38/metacity-3.38.0.tar.xz
Source0  : https://download.gnome.org/sources/metacity/3.38/metacity-3.38.0.tar.xz
...
%prep
%setup -q -n metacity-3.38.0
cd %{_builddir}/metacity-3.38.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602801037
...
cp %{_builddir}/metacity-3.38.0/COPYING %{buildroot}/usr/share/package-licenses/metacity/7222ccadf8bf66ff80f555df6cd9882482d6622e
%make_install
%find_lang metacity

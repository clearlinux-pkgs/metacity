...
Version  : 3.46.0
Release  : 32
URL      : https://download.gnome.org/sources/metacity/3.46/metacity-3.46.0.tar.xz
Source0  : https://download.gnome.org/sources/metacity/3.46/metacity-3.46.0.tar.xz
...
%prep
%setup -q -n metacity-3.46.0
cd %{_builddir}/metacity-3.46.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664906220
